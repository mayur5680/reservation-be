...
import { CreateSeatTypePayload, UpdateSeatTypePayload } from "../../validation";
import {
  getAllSeatType,
  createSeatType,
  updateSeatType,
...
route.get("/outlet/:id", validateAuthorization, getAllSeatType);

route.post(
  "/outlet/:outletId",
  validateAuthorization,
  validate(CreateSeatTypePayload, {}, {}),
  createSeatType
);

route.put(
  "/:seatTypeId/outlet/:outletId",
  validateAuthorization,
  validate(UpdateSeatTypePayload, {}, {}),
  updateSeatType
);
