...
import { getLogsByOutletId, getAllLogs } from "./controller";
import { FilterSystemLogsPayload, SystemLogsPayload } from "../../validation";
...
route.post(
  ...
  validate(FilterSystemLogsPayload, {}, {}),
  getLogsByOutletId
);
